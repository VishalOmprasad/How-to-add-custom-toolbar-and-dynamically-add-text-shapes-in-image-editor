# How to add custom toolbar and dynamically add text shapes in image editor
This repository contains sample that demonstrates how to add custom toolbar and dynamically add text shapes in the [Syncfusion Xamarin.Forms ImageEditor](https://help.syncfusion.com/xamarin/image-editor/getting-started) control.
